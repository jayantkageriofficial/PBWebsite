    ...
    >
      {isAdmin && (
        <div className="absolute top-2 right-2 z-50 flex gap-1.5">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-pbtext hover:text-pbgreen" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg>
          </button>
          <button
            ...
            <div className="relative w-full aspect-square perspective-[1000px] shrink-0">
              ...
              >
                ...
                >
                  ...
                  {company && <p className="text-pbgreen text-xs">@{company}</p>}
                </div>
              </div>
            </div>
          )}
