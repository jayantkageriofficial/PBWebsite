            ...
            <FieldGroup className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Field>
                  ...
                  <Select required onValueChange={setYear}>
                ...
                <Field>
                  <FieldLabel htmlFor="role" className="text-white">Role</FieldLabel>
                  <Input
                    id="role"
                    name="role" 
                    placeholder="Dev"
              ...
              <Field>
                <FieldLabel htmlFor="company" className="text-white">Company</FieldLabel>
                <Input
                  id="company"
                  name="company" 
              ...
              <Field>
                <FieldLabel htmlFor="linkedin" className="text-white">LinkedIn URL</FieldLabel>
                <Input
                  id="linkedin"
                  name="linkedin" 
                  type="url"
                 pattern="^(https?:\/\/)?(www\.)?([a-z]{2}\.)?linkedin\.com\/(in|company)\/[\w\-]+\/?$"
                  placeholder="https://..."
                  className="bg-pbpages border-pbborder text-white"
                />
              </Field>
              ...
              <Field>
                <FieldLabel htmlFor="image" className="text-white">Image</FieldLabel>
                <div className="relative">
                  ...
                  />
                  {fileName && (
                    <p className="mt-2 text-xs text-pbgreen">Selected: {fileName}</p>
                  )}
                </div>
              </Field>
