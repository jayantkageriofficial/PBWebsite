        ...
        <>
            <section className="relative min-h-[30vh] overflow-hidden bg-black text-white flex items-center justify-center">
                <div className="relative z-10 flex flex-col items-center justify-center py-20">
                    <h1 className="text-center text-white tracking-tight select-none text-5xl md:text-6xl lg:text-[64px] font-normal leading-tight md:leading-[150%]">
                        Events
                    </h1>
                </div>
            </section>
            ...
            <section className="bg-black text-white py-14 overflow-hidden">
                <h2 className="text-4xl md:text-5xl lg:text-[64px] font-normal leading-tight md:leading-[150%] text-white mb-8 text-center px-6">
                    Events experience
                </h2>
                <ReviewMarquee />
            </section>
