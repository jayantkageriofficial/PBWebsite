...
export default async function EventsPage() {
    return (
        <>
            <section className="relative min-h-[30vh] overflow-hidden bg-pbpages text-white flex items-center justify-center">
            ...
            <section className="bg-pbpages text-white py-14 overflow-hidden">
